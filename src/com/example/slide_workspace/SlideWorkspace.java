...
public class SlideWorkspace extends ViewGroup {      
    private static final String TAG = "SlideWorkspace";      
    ...
    public SlideWorkspace(Context context, AttributeSet attrs, int defStyle) {      
    ...
    /*public void initScreens(){
	    ...
	    ((ImageView)this.getChildAt(0)).setImageResource(R.drawable.circle); 
	    ((ImageView)this.getChildAt(1)).setImageResource(R.drawable.trangle); 
	    ((ImageView)this.getChildAt(2)).setImageResource(R.drawable.rect); 
    }*/
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {         
        ...
        degreeOffset = preFaceDegree*1.0f/pageWidth;
